...
#include <math.h>
#include "defaults_sf3dmodels.h" /* includes lime_config.h which defines configInfo */
#include "ufunc_types_sf3dmodels.h" /* for the USERFUNC_* macros */
...
void
default_temperature(unsigned int ID_picked, double *temperature){
  temperature[0] = 0.0;
  temperature[1] = 0.0;
