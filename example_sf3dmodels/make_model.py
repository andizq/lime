...
#--------------------
import sf3dmodels.Model as Model     #Model functions
import sf3dmodels.utils.units as u   #Units
import sf3dmodels.rt as rt           #Writing functions for radiative transfer
from sf3dmodels import Plot_model    #Plotting model
import sf3dmodels.Resolution as Res
#-----------------
#Extra libraries
#-----------------
...
lime_init = rt.Lime(GRID)
lime_init.finalmodel(prop)

#-----------------------------
#PRINTING useful PROPERTIES
#-----------------------------
...
#--------------------------------------------------------
#3D PLOTTING (Points trace density - colors the coord. r)
#--------------------------------------------------------
tag = 'Main'
