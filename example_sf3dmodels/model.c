...
input(inputPars *par, image *img){
  ...
  // par->samplingAlgorithm                 = 1; //This option allows the user to build their own gridDensity (fracdensity) function to reject or accept pIntensity points.
  ...
  */
  ...
  //2nd continuum image (at 342 GHz - band 7)
  i=2;
